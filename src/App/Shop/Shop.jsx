  ...
  const dummyLngth = Array(10).fill(1)
    ...
    return (
        ...
        {/* <Slider /> */}
         ...
         <div className='grid p-8 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 gap-4'>
         {products.loading
         ?
        <>
        ...
        {products.data.map((item,idx)=>{
          ...
          <div onClick={() => Navigation(`/product/${item.id}`)} className='lg:w-60 cursor-pointer md:w-32 sm:w-32 lg:h-60 md:h-32 sm:h-32 rounded-lg bg-teal-50/10 flex items-center justify-center'><img src={laptop} className='mix-blend-multiply' alt="" /></div>
